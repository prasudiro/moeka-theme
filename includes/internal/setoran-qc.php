...
<ul class="tab-menu">
	...
	<li class="current"><a href="<?php echo admin_url(); ?>admin.php?page=internal-admin&#038;tab=setoran-qc">Setoran QC</a></li>
...
<form method="post" action="<?php echo admin_url(); ?>admin.php?page=internal-admin&#038;tab=setoran-edit&#038;action=save" enctype="multipart/form-data">
	<table class="form-table">
		...
		<tr>
			<th>unggah berkas</th>
			<td><input type="file" accept="image/jpeg, image/png" name="file-upload" id="file-upload" required /></td>
		</tr>
		<tr>
			<th></th>
			<td>
